...
flash: $(BUILD_DIR)/$(TARGET).elf
	"C:/PROGRAM FILES/XPACK-OPENOCD-0.11.0-4/BIN/OPENOCD.EXE" -f ./openocd.cfg -c "program $(BUILD_DIR)/$(TARGET).elf verify reset exit"

#######################################
# erase
#######################################
erase: $(BUILD_DIR)/$(TARGET).elf
	"C:/PROGRAM FILES/XPACK-OPENOCD-0.11.0-4/BIN/OPENOCD.EXE" -f ./openocd.cfg -c "init; reset halt; stm32f4x mass_erase 0; exit"
